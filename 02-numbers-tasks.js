 ...
 *   5, 5  => 25
 */
const getRectangleArea = (width, height) => height * width; 
 ...
 *   (0,1) (1,2)     => 0
 */
const getAngleBetweenVectors = (x1, y1, x2, y2) => Math.acos((x1 * x2 + y1 * y2) / (Math.hypot(x1, y1) * Math.hypot(x2, y2)));
 ...
 */
const getParallelipidedDiagonal = (a,b,c) => (a*a+b*b+c*c)**0.5;
 ...
 */
const toNumber = (value, def) => (typeof value === 'number' || value instanceof Number || !isNaN(parseInt(value))) ? Number(value) : def;
